...
## Credit
I would like to offer a big thank you to **Paul Dempsey** (aka pachde) for his ["GenericBlank" template](https://github.com/Paul-Dempsey/GenericBlank) which kick-started this project, along with [How to Setup your Windows VS Code Environment for VCV Rack Plugin Development and Debugging](https://medium.com/@tonetechnician/how-to-setup-your-windows-vs-code-environment-for-vcv-rack-plugin-development-and-debugging-6e76c5a5f115) by **tonetechnician**. Also a big thank you to **Andrew Belt** and who else have been part of the development of **VCV Rack**, and plug-ins/modules. Likewise a big thank you to ALL of the people who have made open-source plug-ins for VCV Rack, and those who been active in the Development-section of the VCV forum, and especially those who were willing to answer all of my n00b questions on the forum ... so much to learn.

## License
All source code is copyright © 2024-2026 Infinite-Noise (Pelle Liljendal) and is licensed under the [GPL-3.0+ (GNU General Public License, version v3+)](http://www.gnu.org/licenses/gpl.html).