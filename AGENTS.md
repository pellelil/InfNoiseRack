...
- For published modules, keep backward-compatible patch load; write the new form. Suggest `currentJson` bumps; do not apply them. Do not clamp loaded JSON values unless necessary.
